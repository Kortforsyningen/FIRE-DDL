...
CREATE UNIQUE INDEX SRIDTYPE_U01 ON SRIDTYPE (SRID);
...
CREATE UNIQUE INDEX EVENTTYPE_U01 ON EVENTTYPE (EVENT);
...
CREATE UNIQUE INDEX KOOR_UNIQ_001 ON KOORDINAT (SRID, PUNKTID, REGISTRERINGTIL);


CREATE UNIQUE INDEX PUNKTINFOTYPE_IDX_01 ON PUNKTINFOTYPE (INFOTYPE);
