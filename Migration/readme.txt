...
Make sure that the function random_uuid() has been created on the database. Use the following SQL to do that:
...
For some reason creating the function doesn't work well with sqlplus.