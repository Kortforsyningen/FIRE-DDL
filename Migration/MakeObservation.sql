...
SELECT UUID, SYSDATE, 'observation_indsat', '4f8f29c8-c38f-4c69-ae28-c7737178de1f'
FROM OBSSAGSEVENTID;  
...
INTO OBSERVATION (
  ...
  VALUE9, VALUE10, VALUE11, VALUE12, VALUE13, VALUE14, VALUE15, SAGSEVENTID
) 
VALUES (
  REGISTRERINGFRA, REGISTRERINGTIL, OBSERVATIONSTIDSPUNKT,
  SIGTEPUNKTID, OBSERVATIONSTYPEID, ANTAL, GRUPPE, OPSTILLINGSPUNKTID,
...
SELECT 
  ...
  (SELECT OBSERVATIONSTYPEID FROM OBSERVATIONTYPE WHERE OBSERVATIONSTYPE = 'geometrisk_koteforskel' AND ROWNUM <= 1),
  opst.SETS AS ANTAL,
...
SELECT 
  ...
  NVL(obs.OBS_DATE, TO_DATE(opst.YEAR, 'YYYY')) AS OBSERVATIONSTIDSPUNKT,
  obsconv.ID AS SIGTEPUNKTID,
  (SELECT OBSERVATIONSTYPEID FROM OBSERVATIONTYPE WHERE OBSERVATIONSTYPE = 'trigonometrisk_koteforskel' AND ROWNUM <= 1),
  opst.SETS AS ANTAL,
  grp.GROUPID AS GRUPPE,
  opstconv.ID AS OPSTILLINGSPUNKTID,
  obs.OBS AS VALUE1,
...
SELECT 
  ...
  obsconv.ID AS SIGTEPUNKTID,
  (SELECT OBSERVATIONSTYPEID FROM OBSERVATIONTYPE WHERE OBSERVATIONSTYPE = 'zenitvinkel' AND ROWNUM <= 1),
  opst.SETS AS ANTAL,
  grp.GROUPID AS GRUPPE,
  opstconv.ID AS OPSTILLINGSPUNKTID,
  obs.OBS AS VALUE1,
...
SELECT 
  ...
  TO_DATE(CASE WHEN opst.YEAR IS NULL OR opst.YEAR < 1700 THEN 1700 ELSE opst.YEAR END, 'YYYY') AS OBSERVATIONSTIDSPUNKT,
  obsconv.ID AS SIGTEPUNKTID,
  (SELECT OBSERVATIONSTYPEID FROM OBSERVATIONTYPE WHERE OBSERVATIONSTYPE = 'skråafstand' AND ROWNUM <= 1),
  opst.SETS AS ANTAL,
  grp.GROUPID AS GRUPPE,
  opstconv.ID AS OPSTILLINGSPUNKTID,
  obs.OBS AS VALUE1,
...
SELECT 
  ...
  TO_DATE(CASE WHEN opst.YEAR IS NULL OR opst.YEAR < 1700 THEN 1700 ELSE opst.YEAR END, 'YYYY') AS OBSERVATIONSTIDSPUNKT,
  obsconv.ID AS SIGTEPUNKTID,
  (SELECT OBSERVATIONSTYPEID FROM OBSERVATIONTYPE WHERE OBSERVATIONSTYPE = 'vektor' AND ROWNUM <= 1),
  opst.SETS AS ANTAL,
  grp.GROUPID AS GRUPPE,
  opstconv.ID AS OPSTILLINGSPUNKTID,
  obs.OBSN AS VALUE1,
...
SELECT 
  ...
  TO_DATE(CASE WHEN opst.YEAR IS NULL OR opst.YEAR < 1700 THEN 1700 ELSE opst.YEAR END, 'YYYY') AS OBSERVATIONSTIDSPUNKT,
  obsconv.ID AS SIGTEPUNKTID,
  (SELECT OBSERVATIONSTYPEID FROM OBSERVATIONTYPE WHERE OBSERVATIONSTYPE = 'retning' AND ROWNUM <= 1),
  opst.SETS AS ANTAL,
  grp.GROUPID AS GRUPPE,
  opstconv.ID AS OPSTILLINGSPUNKTID,
  obs.OBS AS VALUE1,
...
SELECT 
  ...
  TO_DATE(CASE WHEN opst.YEAR IS NULL OR opst.YEAR < 1700 THEN 1700 ELSE opst.YEAR END, 'YYYY') AS OBSERVATIONSTIDSPUNKT,
  obsconv.ID AS SIGTEPUNKTID,
  (SELECT OBSERVATIONSTYPEID FROM OBSERVATIONTYPE WHERE OBSERVATIONSTYPE = 'horisontalafstand' AND ROWNUM <= 1),
  opst.SETS AS ANTAL,
  grp.GROUPID AS GRUPPE,
  opstconv.ID AS OPSTILLINGSPUNKTID,
  obs.OBS AS VALUE1,
