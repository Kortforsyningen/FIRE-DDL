...
INSERT INTO SRIDTYPE (BESKRIVELSE, SRID) VALUES ('Ingen beskrivelse','EPSG:4909');
INSERT INTO SRIDTYPE (BESKRIVELSE, SRID) VALUES ('Ingen beskrivelse','EPSG:5317');
INSERT INTO SRIDTYPE (BESKRIVELSE, SRID) VALUES ('Ingen beskrivelse','EPSG:5799');
...
SELECT DISTINCT ('Lokalt højdesystem for tidsserie over Jessenpunkt ' || ts.JNR_BSIDE), 'TS:' || ts.JNR_BSIDE 
