...
INSERT INTO PUNKTINFOTYPE (INFOTYPEID, ANVENDELSE, BESKRIVELSE, INFOTYPE) VALUES (FLOOR(dbms_random.value(1,1E9)),'FLAG','Fikspunkt på postament','AFM:postament');
-- AFM:xxx (311 stk)
...
INSERT INTO PUNKTINFOTYPE (INFOTYPEID, ANVENDELSE, BESKRIVELSE, INFOTYPE) VALUES (FLOOR(dbms_random.value(1,1E9)), 'FLAG','Sømærke','ATTR:sømærke');
INSERT INTO PUNKTINFOTYPE (INFOTYPEID, ANVENDELSE, BESKRIVELSE, INFOTYPE) VALUES (FLOOR(dbms_random.value(1,1E9)), 'FLAG','Teknikpunkt','ATTR:teknikpunkt');
INSERT INTO PUNKTINFOTYPE (INFOTYPEID, ANVENDELSE, BESKRIVELSE, INFOTYPE) VALUES (FLOOR(dbms_random.value(1,1E9)), 'FLAG','Aerotriangulationspunkt','ATTR:aerotriangulationspunkt');
